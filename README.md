# Home-Automation-using-ESP8266-in-IOT-Basic-Model
Home automation using IoT with the ESP8266 microcontroller allows smart control of appliances over the internet.
